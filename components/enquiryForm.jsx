...
import Funcs from '../src/features/data'
...
function sturc({mainStyle=false}) {
  ...
  const onSubmit = async(data) => {
    ...
    try{
      ...
      let response= await Funcs?.createForm(data);
  ...
  return (
    <MainCont className={mainStyle ? "customMain" : ""}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input disabled={status !=="loading...." ? false : true} className={status ===0 ? "animate-spin  submit " : "submit"} type="submit" />
